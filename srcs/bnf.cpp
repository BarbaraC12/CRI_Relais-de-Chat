...
void	init_bnf_msg(std::map<int, std::string> &map_bnf_msg)
{
	...
	map_bnf_msg[ERR_NOADMININFO] = "<server> :No administrative info available";
	map_bnf_msg[ERR_FILEERROR] = "::File error doing <file op> on <file>";
	map_bnf_msg[ERR_NONICKNAMEGIVEN] = ":No nickname given";
	map_bnf_msg[ERR_ERRONEUSNICKNAME] = "<nick> :Erroneous nickname";
	map_bnf_msg[ERR_NICKNAMEINUSE] = "<nick> :Nickname is already in use";
	map_bnf_msg[ERR_NICKCOLLISION] = "<nick> :Nickname collision KILL from <user>@<host>";
	map_bnf_msg[ERR_UNAVAILRESOURCE] = "<nick/channel/service> :Nick/channel is temporarily unavailable";
	map_bnf_msg[ERR_USERNOTINCHANNEL] = "<nick> <channel> :They aren't on that channel";
	map_bnf_msg[ERR_NOTONCHANNEL] = "<channel> :You're not on that channel";
	map_bnf_msg[ERR_USERONCHANNEL] = "<nick> <channel> :is already on channel";
	map_bnf_msg[ERR_NOLOGIN] = "<user> :User not logged in";
	map_bnf_msg[ERR_SUMMONDISABLED] = ":SUMMON has been disabled";
	map_bnf_msg[ERR_USERSDISABLED] = "::USERS has been disabled";
	map_bnf_msg[ERR_NOTREGISTERED] = ":You have not registered";
	map_bnf_msg[ERR_NEEDMOREPARAMS] = "<command> :Not enough parameters";
	map_bnf_msg[ERR_ALREADYREGISTRED] = ":Unauthorized command (already registered)";
	map_bnf_msg[ERR_NOPERMFORHOST] = ":Your host isn't among the privileged";
	map_bnf_msg[ERR_PASSWDMISMATCH] = ":Password incorrect";
	map_bnf_msg[ERR_YOUREBANNEDCREEP] = ":You are banned from this server";
